...
@onready var trash_label = $TrashCounter
@onready var drain_label = $DrainCounter
...
func update_trash_count(current_amount: int, goal_amount: int):
	trash_label.text = str(current_amount) + " / " + str(goal_amount)

# --------------------
# DRAIN COUNTER
# --------------------
func update_drain_count(current_amount: int, goal_amount: int):
	drain_label.text = str(current_amount) + " / " + str(goal_amount)
